  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-10 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky
          ? "sticky-navbar shadow-lg bg-base-200 dark:bg-slate-600 dark:text-white duration-300 trasition-all ease-in-out"
          : ""
      }`}
    >
      <div className="navbar ">
        ...
        <div className="nabar-end space-x-6">
          ...
          <div className="">
            <a
              className=" ml-10 md:ml-0 bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
