...
function Navbar() {
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-10 px-4 fixed top-0 left-0 right-0 ${
        sticky
          ? "sticky-navbar shadow-lg bg-base-200 duration-300 trasition-all ease-in-out"
          : ""
      }`}
    >
